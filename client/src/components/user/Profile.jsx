...
const Profile = () => {
    ...
    const [picturesToShow, setPicturesToShow] = useState(1);
    const [ordersToShow, setOrdersToShow] = useState(1);
    ...
    const loadMorePictures = () => {
        if (picturesToShow > user?.pictures.length) {
            ...
            setPicturesToShow(
                (prevPicturesToShow) => (prevPicturesToShow += 1)
            );
        }
    };
